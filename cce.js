...
class GoogleSheetsAPI {
    constructor() {
        this.apiUrl = "https://script.google.com/macros/s/AKfycbx4lMlRlP4xNwbLDdwJKK7dKlXRQc5SRQubwAco7psOmuI1XoeL5xWWn7OeY_Frq_mp/exec";
        this.cache = new Map();
...
function getSubjectIcon(subject) {
    ...
    if (subjectLower.includes('muqarana')) return 'fas fa-scroll';
                    ...
                    bracketMatches.forEach(match => {
                        ...
                        if (classNum && subjectsString) {
                            const subjects = subjectsString.toLowerCase() === 'all' 
                                ? ['muqarana', 'arabic_wing', 'urdu_wing', 'english_wing', 'malayalam_wing', 'media_wing', 'sigma_wing', 'art_wing', 'oration_wing', 'gk_wing', 'himaya_wing', 'class', 'swalah']
